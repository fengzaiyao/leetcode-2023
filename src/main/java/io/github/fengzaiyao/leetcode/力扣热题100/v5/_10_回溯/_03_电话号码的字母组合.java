...
public class _03_电话号码的字母组合 {
    ...
    public List<String> letterCombinations(String digits) {
        ...
        doLetterCombinations(ans, digits, 0, new StringBuilder());
        return ans;
    }

    public void doLetterCombinations(List<String> ans, String digits, int begin, StringBuilder builder) {
        ...
        for (Character ch : chs) {
            builder.append(ch);
            doLetterCombinations(ans, digits, begin + 1, builder);
