...
public class _03_电话号码的字母组合 {
    ...
    public List<String> letterCombinations(String digits) {
        ...
        doLetter(ans, new StringBuilder(), digits, 0);
        return ans;
    }

    public void doLetter(List<String> ans, StringBuilder builder, String digits, int begin) {
        ...
        for (Character ch : chs) {
            builder.append(ch);
            doLetter(ans, builder, digits, begin + 1);
