...
public class _03_电话号码的字母组合 {
    ...
    public List<String> letterCombinations(String digits) {
        ...
        doLetterCombinations(ans, digits, new StringBuilder(), 0);
        return ans;
    }

    public void doLetterCombinations(List<String> ans, String digits, StringBuilder builder, int begin) {
        ...
        for (Character ch : chs) {
            builder.append(ch);
            doLetterCombinations(ans, digits, builder, begin + 1);
