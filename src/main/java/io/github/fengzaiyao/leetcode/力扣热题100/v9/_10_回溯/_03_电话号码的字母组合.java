...
public class _03_电话号码的字母组合 {
    ...
    public List<String> letterCombinations(String digits) {
        ...
        doLetter(ans, digits, new StringBuilder(), 0);
        return ans;
    }

    private void doLetter(List<String> ans, String digits, StringBuilder builder, int begin) {
        ...
        for (Character ch : chs) {
            builder.append(ch);
            doLetter(ans, digits, builder, begin + 1);
